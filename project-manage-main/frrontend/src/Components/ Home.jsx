...
import Img from './images/poroda.jpeg'
...
<br />        <Typography variant='h5' fontStyle={'bold'} color={'whitesmoke'}>Pala,Kottayam</Typography>
        ...
        <Typography variant='h6' color={'black'} align='centre'> TO US, FOOD IS EVERYTHING. <br />WE’RE PROUD TO SHARE OUR TRADITIONS WITH YOU. </Typography>
    
        <Typography variant='h6' color={'black'} align='centre'> CONTACT US </Typography>
